...
from .models import User, Category, LanguageFile, PushDevice
from simapp.utils import ExportCsvMixin
...
class UserAdmin(BaseUserAdmin, ExportCsvMixin):
    ...
    list_display = ('email', 'username', 'is_admin', 'role', 'is_active')
    list_filter = ('is_admin', 'role', 'is_active')
    fieldsets = (
        (None, {'fields': ('email', 'password', 'username')}),
        ('Personal info', {'fields': ('first_name', 'last_name', 'language')}),
